...
See the [image-removal receipt](docs/operations/IMAGE_REMOVAL_RELEASE_2026-09-08.md) for exact host, evidence attribution,
...
Use the [article-recovery receipt](docs/operations/ARTICLE_RECOVERY_RELEASE_2026-09-08.md) for exact scope, source and limits.
