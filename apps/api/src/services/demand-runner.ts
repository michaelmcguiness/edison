...
import { demandDiscoveryContractCompatibilityFailure } from "./demand-discovery-contract";
...
export function initialDemandState(
  ...
  return {
    ...
    ...(Object.hasOwn(request.snapshot, "discoveryContractVersion")
      ? { discoveryContractVersion: request.snapshot.discoveryContractVersion } : {}),
...
export function demandProgressCompatibilityFailure(
  ...
  const discoveryFailure = demandDiscoveryContractCompatibilityFailure(request, state);
